...
dataFlow(cam11, mainDB, detection, [enc_iot, enc_storage], 0.02, 80, 40).
dataFlow(cam21, mainDB, detection, [enc_iot, enc_storage], 0.02, 80, 40).
dataFlow(cam12, detector, detection, [enc_iot, wireless_security], 0.02, 80, 40).
dataFlow(cam22, detector, detection, [enc_iot, wireless_security], 0.02, 80, 40).
dataFlow(detector, recognizer, bbox, [anti_tampering], 0.03, 50, 40).
dataFlow(recognizer, traje, plateNumber, [anti_tampering], 0.01, 50, 40).
dataFlow(recognizer, mainDB, detection, [anti_tampering, enc_storage], 0.02, 50, 60).
dataFlow(mainDB, traje, detection, [anti_tampering, node_isolation], 0.1, 50, 40).
dataFlow(traje, logger, detection, [user_data_isolation], 0.02, 50, 40).
dataFlow(logger, mainDB, status, [enc_storage, public_key_crypto], 0.05, 50, 40).