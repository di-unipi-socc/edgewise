...
dataFlow(snsQueue, mainDB, snsLevel, [anti_tampering, obfuscated_storage], 0.04, 90, 300).
dataFlow(ctrlQueue, mainDB, ctrlLevel, [anti_tampering, obfuscated_storage], 0.08, 50, 300).
dataFlow(imgQueue, mainDB, picture, [anti_tampering], 0.1, 100, 1000).

dataFlow(imgQueue, calibre, picture, [firewall], 0.1, 100, 300).
