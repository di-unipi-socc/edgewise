...
SEC_CAPS_CLOUD 	= ['access_logs', 'authentication', 'process_isolation', 'permission_model', 'resource_monitoring', 'restore_point', 'user_data_isolation', # virtualisation
...
SEC_CAPS_EDGE 	= ['access_logs', 'authentication', 'process_isolation', 'permission_model', 'resource_monitoring', 'user_data_isolation', # virtualisation
                'certificates', 'firewall', 'enc_iot', 'node_isolation', 'network_ids', 'public_key_crypto', 'wireless_security', # communications
                'backup', 'enc_storage', 'obfuscated_storage', # data,
                'access_control', 'anti_tampering', # physical
                'audit'] # others

SEC_CAPS_IOT 	= ['access_logs', 'authentication', 'resource_monitoring', # virtualisation
