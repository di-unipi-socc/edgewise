...
node(n5, accesspoint, [ubuntu, gcc, python], (x86, 128), [enc, auth], []).
...
node(n3, thing, [android, gcc, python], (x86, 64), [enc, auth], [echoDot]).
node(n0, cloud, [ubuntu, mySQL, gcc, python], (arm64, 1024), [enc, auth], []).
